...
const BabylonWorkspaceContent: React.FC<any> = ({
  ...
  // Create sceneManager object
  const sceneManager = {
    getScene: () => null, // This would be connected to actual Babylon.js scene
    autoCenterAndScale: (meshes: AbstractMesh[]) => {
      // Placeholder implementation
      console.log('Auto centering and scaling meshes:', meshes.length);
    },
